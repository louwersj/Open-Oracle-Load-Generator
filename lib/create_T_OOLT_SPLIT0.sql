 ...
 */
 ...
 CREATE TABLE T_OOLT_SPLIT0
  (
    ...
    CONSTRAINT T_OOLT_SPLIT0_PK PRIMARY KEY ( ID ) USING INDEX ( CREATE UNIQUE INDEX T_OOLT_SPLIT0_PK ON T_OOLT_SPLIT0 (ID ASC) LOGGING TABLESPACE SYSTEM PCTFREE 10 INITRANS 2 STORAGE ( INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS UNLIMITED FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT ) NOPARALLEL ) ENABLE
  )
