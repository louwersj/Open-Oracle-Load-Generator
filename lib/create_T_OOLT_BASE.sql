 ...
 */
 ...
 CREATE TABLE T_OOLT_BASE
  (
    ...
    CONSTRAINT T_OOLT_BASE_PK PRIMARY KEY ( ID ) USING INDEX ( CREATE UNIQUE INDEX T_OOLT_BASE_PK ON T_OOLT_BASE (ID ASC) LOGGING TABLESPACE SYSTEM PCTFREE 10 INITRANS 2 STORAGE ( INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS UNLIMITED FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT ) NOPARALLEL ) ENABLE
  )
